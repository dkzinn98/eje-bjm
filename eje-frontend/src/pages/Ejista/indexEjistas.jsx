...
const IndexEjista = () => {
  ...
  const validateForm = () => {
    ...
    } else if (formData.idade < 14 || formData.idade > 25) {
      newErrors.idade = 'Idade deve estar entre 14 e 25 anos';
    }
    ...
    if (!formData.motivacao.trim()) {
      newErrors.motivacao = 'Este campo é obrigatório';
    } else if (formData.motivacao.trim().length < 50) {
      newErrors.motivacao = 'Deve ter pelo menos 50 caracteres';
    }
  ...
  return (
    <Container>
      ...
      <Form onSubmit={handleSubmit}>
        <Title>Inscrição para EJE 2025</Title>
        ...
        <TextoContainer>
          <InputLabel>Por que você quer participar do EJE 2025? *</InputLabel>
          <textarea
            placeholder="Conte-nos resumidamente sua motivação para participar do EJE 2025. (Mínimo 50 caracteres e máximo 500)"
